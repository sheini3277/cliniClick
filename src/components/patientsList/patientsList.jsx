...
import { FaUserPlus, FaCalendarAlt, FaCalendarPlus, FaListAlt, FaFilePdf, FaChartLine, FaRemoveFormat, FaTrashRestore } from "react-icons/fa";
import { deletePatientThunk } from "../../redux/slices/deletePatient";
                    ...
                    {filteredPatients.map(p => p && (
                        <div className="patient-card fade-in" key={p.pationtId}>
                            ...
                            <div className="patient-actions">
                                ...
                                <button 
                                    className="patient-action-button" 
                                    onClick={() => navigate(`/showTreatmentReport/${num}`)}
                                >
                                ...
                                <button 
                                    className="patient-action-button" 
                                    onClick={() => dispatch(deletePatientThunk(p.pationtId))}
                                >
                                    <FaTrashRestore className="action-icon" />
                                    <span>מחיקת מטופל</span>
                                </button>
                            </div>
                        </div>
                    ))}
